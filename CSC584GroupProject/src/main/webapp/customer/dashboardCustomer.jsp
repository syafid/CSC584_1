  ...
  <div class="container">
    <nav>
      <ul>
        ...
        <li><!-- <a href="/CSC584GroupProject/registration/UpdateCustomer.jsp?cusID=<%=datalogin.get(recordCount).getCusID()%>"> -->
         <a href="UpdateCustomerServlet?cusID=<%=datalogin.get(recordCount).getCusID()%>">
          <i class="fas fa-user-cog"></i>
          <span class="nav-item">Update Info</span>
        </a></li>
